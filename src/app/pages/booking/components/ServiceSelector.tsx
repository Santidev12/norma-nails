  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-beige-800 max-w-2xl mx-auto">
          ...
          <div
            ...
            className={`relative bg-white rounded-2xl shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl ${
              selectedService?.id === service.id
                ? 'ring-4 ring-beige-300 ring-opacity-60'
                : ''
            }`}
            onClick={() => onServiceSelect(service)}
          >
            {/* Header con imagen */}
            <div className="h-48 bg-linear-to-br from-beige-100 to-beige-200 flex items-center justify-center">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-bold text-beige-600">
                  {service.price}
                </span>
              </div>

              {selectedService?.id === service.id && (
                <div className="mt-4 bg-beige-50 rounded-lg p-3 border border-beige-200">
                  <p className="text-beige-700 text-sm font-medium text-center">
